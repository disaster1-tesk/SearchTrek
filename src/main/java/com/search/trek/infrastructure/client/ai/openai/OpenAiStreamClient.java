...
import com.search.trek.infrastructure.client.ai.openai.entity.chat.Functions;
...
import com.search.trek.infrastructure.client.ai.openai.sse.ConsoleEventSourceListener;
import com.search.trek.infrastructure.client.ai.openai.sse.DefaultPluginListener;
import com.search.trek.infrastructure.client.ai.openai.sse.PluginListener;
...
public class OpenAiStreamClient {
    ...
    public void streamCompletions(Completion completion, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            log.info("参数异常：EventSourceListener不能为空，可以参考：com.weaver.sdk.openai.sse.ConsoleEventSourceListener");
            throw new BaseException(CommonError.PARAM_ERROR);
        }
        if (StrUtil.isBlank(completion.getPrompt())) {
            log.info("参数异常：Prompt不能为空");
            throw new BaseException(CommonError.PARAM_ERROR);
        }
